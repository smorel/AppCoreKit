...
+ (CKFormCellDescriptor*)cellDescriptorWithProperty:(CKObjectProperty*)property enumDefinition:(NSDictionary*)enumDefinition multiSelectionEnabled:(BOOL)multiSelectionEnabled readOnly:(BOOL)readOnly;
