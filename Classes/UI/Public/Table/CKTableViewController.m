...
- (CGRect)backgroundViewFrame{
    CGRect backgroundViewRect = CGRectMake(self.tableView.bounds.origin.x + self.backgroundViewInsets.left,
                                           self.tableView.bounds.origin.y + self.backgroundViewInsets.top,
...
- (CGRect)foregroundViewFrame{
    CGRect foregroundViewRect = CGRectMake(self.tableView.bounds.origin.x + self.foregroundViewInsets.left,
                                           self.tableView.bounds.origin.y + self.foregroundViewInsets.top,
