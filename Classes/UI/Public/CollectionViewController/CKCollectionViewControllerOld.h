//
//  CKCollectionViewControllerOld.h
//  AppCoreKit
//
...
/** This controller implements the logic to deals with objects via objectcontroller and cellControllerfactory.
   ...
   to the basic implementation of CKCollectionViewControllerOld
...
*/
@interface CKCollectionViewControllerOld : CKViewController<CKObjectControllerDelegate>

///-----------------------------------
/// @name Initializing a CKCollectionViewControllerOld Object
///-----------------------------------
...
///-----------------------------------
/// @name Setupping a CKCollectionViewControllerOld Object at runtime
///-----------------------------------
...
///-----------------------------------
/// @name Getting the CKCollectionViewControllerOld status
///-----------------------------------
...
/**
 */
@protocol CKCollectionViewControllerOldDelegate
@optional
...
/**
 */
- (void)collectionViewController:(CKCollectionViewControllerOld*)controller didSelectViewAtIndexPath:(NSIndexPath*)indexPath withObject:(id)object;

/**
 */
- (void)collectionViewController:(CKCollectionViewControllerOld*)controller didSelectAccessoryViewAtIndexPath:(NSIndexPath*)indexPath withObject:(id)object;
@end