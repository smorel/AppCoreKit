...
/**
 */
@interface CKPropertyTextView : CKTextView<UITextViewDelegate>
...
/**
 */
@property (nonatomic,copy) void(^didResignFirstResponder)(CKPropertyTextView* textView);

/**
 */
@property (nonatomic,copy) void(^didBecomeFirstResponder)(CKPropertyTextView* textView);
